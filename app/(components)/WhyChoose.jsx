...
export const WhyChoose = () => {
  const reasons = [
    ...
    {
      id: 3,
      title: "AI That Adapts = Better Results",
      description: "Our intelligent personalization engine goes beyond templates, creating truly dynamic plans that drive superior member outcomes.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  return (
    <section className="py-16 md:py-24 bg-gradient-to-b from-blue-50 to-white" id="why-choose">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="mt-16 p-8 bg-[#007BFF] text-white rounded-xl shadow-lg relative overflow-hidden"
        >
          <div className="absolute top-0 right-0 w-64 h-64 bg-blue-600 rounded-full -translate-y-32 translate-x-32 opacity-50"></div>
          <div className="absolute bottom-0 left-0 w-64 h-64 bg-blue-600 rounded-full translate-y-32 -translate-x-32 opacity-50"></div>
